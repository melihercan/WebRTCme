...
namespace WebRtcJsInterop.Extensions
{
    ...
    public static class JsRuntimeExtension
    {
        ...
        public static async ValueTask<JsRuntimeObjectRef> GetWindowPropertyRef(this IJSRuntime jsRuntime,
            string propertyPath)
        {
            return await jsRuntime.InvokeAsync<JsRuntimeObjectRef>("webRtcInterop2.getPropertyRef", propertyPath).ConfigureAwait(false);
        }
        ...
        {
            return await jsRuntime.InvokeAsync<T>("webRtcInterop2.getInstancePropertySerializable", jsObjectRef,
        ...
        {
            await jsRuntime.InvokeVoidAsync("webRtcInterop2.setInstanceProperty", jsObjectRef, propertyPath, value).ConfigureAwait(false);
        }
            ...
            JsRuntimeObjectRef jsObjectRef, string propertyPath)
        {
            var jsRuntimeObjectRef =
                await jsRuntime.InvokeAsync<JsRuntimeObjectRef>("webRtcInterop2.getInstancePropertyRef", jsObjectRef,
        ...
        {
            await jsRuntime.InvokeVoidAsync("webRtcInterop2.callInstanceMethod",
            ...
            JsRuntimeObjectRef windowObject, string methodName, params object[] arguments)
        {
            ...
            return await jsRuntime.InvokeAsync<T>("webRtcInterop2.callInstanceMethod",
                new object[] {windowObject, methodName}.Concat(arguments).ToArray()).ConfigureAwait(false);
        }
        ...
        {
            return await jsRuntime.InvokeAsync<T>("webRtcInterop2.returnInstance", jsObject, serializationSpec).ConfigureAwait(false);
        }
            ...
            JsRuntimeObjectRef windowObject, string methodName, params object[] arguments)
        {
            ...
            var jsRuntimeObjectRef = await jsRuntime.InvokeAsync<JsRuntimeObjectRef>(
                "webRtcInterop2.callInstanceMethodGetRef",
                new object[] {windowObject, methodName}.Concat(arguments).ToArray()).ConfigureAwait(false);
            jsRuntimeObjectRef.JsRuntime = jsRuntime;
            return jsRuntimeObjectRef;
        }
        ...
        public static async ValueTask<bool> HasProperty(this IJSRuntime jsRuntime, JsRuntimeObjectRef jsObject,
            string propertyPath)
        {
            return await jsRuntime.InvokeAsync<bool>("webRtcInterop2.hasProperty", jsObject, propertyPath).ConfigureAwait(false);
        }
        ...
        //{
        //    var listenerId = await jsRuntime.InvokeAsync<int>("webRtcInterop2.addEventListener", jsRuntimeObject,
        //        propertyName, eventName, callBack).ConfigureAwait(false);

        //    return new ActionAsyncDisposable(async () =>
        //        await jsRuntime.InvokeVoidAsync("webRtcInterop2.removeEventListener", jsRuntimeObject, propertyName,
