...
namespace WebRTCme.MacCatalyst
{
    internal class MediaDevices : NativeBase<object>, IMediaDevices
    {
        ...
        public Task<MediaDeviceInfo[]> EnumerateDevices()
        {
            ...
            // The iOS copy of this still had a "TODO: FIXME" placeholder media type here, which
            // would never have matched a device. AVMediaTypes.Audio is the modern equivalent of
            // the old AVMediaType.Audio constant.
