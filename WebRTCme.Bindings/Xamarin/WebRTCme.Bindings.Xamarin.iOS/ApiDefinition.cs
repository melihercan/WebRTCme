...
////namespace WebRTCme.Bindings.Xamarin.iOS
{
	...
	*/
	...
	[BaseType(typeof(NSObject))]
	interface RTCDefaultVideoDecoderFactory : /****I****/RTCVideoDecoderFactory
	{
	}

	// @interface RTCDefaultVideoEncoderFactory : NSObject <RTCVideoEncoderFactory>
	[BaseType(typeof(NSObject))]
	interface RTCDefaultVideoEncoderFactory : /****I****/RTCVideoEncoderFactory
	{
	...
	interface RTCDispatcher
	{
		...
		void DispatchAsyncOnType(RTCDispatcherQueueType dispatchType, /****dispatch_block_t****/Action block);
	...
	interface RTCDataChannelDelegate
	{
		...
		void /*DataChannel*/DidChangeState(RTCDataChannel dataChannel);
	...
	interface RTCPeerConnection_Stats
	{
		...
		void StatsForTrack([NullAllowed] RTCMediaStreamTrack mediaStreamTrack, RTCStatsOutputLevel statsOutputLevel, [NullAllowed] Action<NSArray</****RTCLegacyStatsReport****/NSObject>> completionHandler);
	...
	interface RTCPeerConnectionFactory
	{
		...
		RTCPeerConnection PeerConnectionWithConfiguration(RTCConfiguration configuration, RTCMediaConstraints constraints, [NullAllowed] /****RTCPeerConnectionDelegate****/IRTCPeerConnectionDelegate @delegate);
	...
	*/
	...
	interface RTCStatisticsReport
	{
		...
		[Export("statistics")]
		NSDictionary<NSString, /****RTCStatistics****/NSObject> Statistics { get; }
	}
