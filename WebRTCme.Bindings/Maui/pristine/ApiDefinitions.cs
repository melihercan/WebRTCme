...
*/[Protocol]
	interface RTCYUVPlanarBuffer : IRTCVideoFrameBuffer
	{
		...
		unsafe NativeHandle Height (int width, int height, byte* dataY, byte* dataU, byte* dataV);

		// @required -(instancetype _Nonnull)initWithWidth:(int)width height:(int)height;
		[Abstract]
		[Export ("initWithWidth:height:")]
		NativeHandle Height (int width, int height);
		...
		NativeHandle Height (int width, int height, int strideY, int strideU, int strideV);
	}
...
*/[Protocol]
	...
	unsafe delegate int RTCAudioDeviceGetPlayoutDataBlock (AudioUnitRenderActionFlags* arg0, AudioTimeStamp* arg1, nint arg2, uint arg3, AudioBufferList* arg4);
	...
	unsafe delegate int RTCAudioDeviceRenderRecordedDataBlock (AudioUnitRenderActionFlags* arg0, AudioTimeStamp* arg1, nint arg2, uint arg3, AudioBufferList* arg4, [NullAllowed] void* arg5);
	...
	unsafe delegate int RTCAudioDeviceDeliverRecordedDataBlock (AudioUnitRenderActionFlags* arg0, AudioTimeStamp* arg1, nint arg2, uint arg3, [NullAllowed] AudioBufferList* arg4, [NullAllowed] void* arg5, [NullAllowed] RTCAudioDeviceRenderRecordedDataBlock arg6);
...
*/[Protocol]
	...
	interface RTCAudioSessionDelegate
	{
		...
		void AudioSession (RTCAudioSession audioSession, NSError error);
	}
...
*/[Protocol]
	...
	interface RTCPeerConnectionDelegate
	{
		...
		void PeerConnection (RTCPeerConnection peerConnection, RTCIceCandidateErrorEvent @event);
	}
